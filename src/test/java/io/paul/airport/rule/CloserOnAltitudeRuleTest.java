...
class CloserOnAltitudeRuleTest {
    CloserOnAltitudeRule closerOnAltitudeRule;
    Clock mockClock;

    @BeforeEach
    void setup() {
        mockClock = new FakeClock(2000, 4, 20, 12, 0, 0);
        closerOnAltitudeRule = new CloserOnAltitudeRule();
    }
    ...
    void should_landing_rules_return_next_airplane() {
        ...
        Optional<FlightNumber> airplane = closerOnAltitudeRule.apply(airplanes, mockClock);
